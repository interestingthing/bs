...
//import personal.bs.service.SellerService;
//
...
//
//	@Resource
//	private StorePOMapper sellerMapper;
//
//	/**
//	 * 查询全部
//	 */
...
//		Page<StorePO> page=   (Page<StorePO>) sellerMapper.selectByExample(null);
...
////		}
//
//		Page<StorePO> page= (Page<StorePO>)sellerMapper.selectByExample(example);
//		return new PageResult(page.getTotal(), page.getResult());
//	}
//
//
...
////		StorePO seller = sellerMapper.selectByPrimaryKey(sellerId);
////
