...
public interface TbGoodsDescMapper {
     ...
     */
    @Insert({
        "insert into spu_desc (spuId, introduction, ",
    ...
    @Select({
        "select",
        "id, spuId, introduction, specification_items, custom_attribute_items, item_images, ",
        "package_list, sale_service",
        "from spu_desc",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @ResultMap("personal.bs.dao.mapper.TbGoodsDescMapper.BaseResultMap")
    TbGoodsDesc selectByPrimaryKey(Integer id);
