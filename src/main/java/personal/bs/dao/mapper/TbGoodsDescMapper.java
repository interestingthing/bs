...
public interface TbGoodsDescMapper {
    ...
    @Delete({
        ...
        "where spuId = #{spuid,jdbcType=INTEGER}"
    })
     ...
     */
    @Insert({
        "insert into spu_desc (introduction, specification_items, ",
        "custom_attribute_items, item_images, ",
        "package_list, sale_service)",
        "values (#{introduction,jdbcType=VARCHAR}, #{specificationItems,jdbcType=VARCHAR}, ",
        "#{customAttributeItems,jdbcType=VARCHAR}, #{itemImages,jdbcType=VARCHAR}, ",
        "#{packageList,jdbcType=VARCHAR}, #{saleService,jdbcType=VARCHAR})"
    })
    @Options(useGeneratedKeys=true,keyProperty="spuid")
    ...
    @Select({
        "select",
        "spuId, introduction, specification_items, custom_attribute_items, item_images, ",
        "package_list, sale_service",
        "from spu_desc",
        "where spuId = #{spuid,jdbcType=INTEGER}"
    })
