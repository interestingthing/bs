...
Version: 3.4.8 Timestamp: Thu May  2 09:50:32 EDT 2014
...
(function ($, undefined) {
     ...
     *      Example: {results:[{id:2, text:'Red'},{id:2, text:'Blue'}], more:true}
     */
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        blur: function () {
            ...
            // synonymous to .is(':focus'), which is available in jquery >= 2.6
        ...
        getPlaceholder: function () {
            ...
            return this.opts.element.attr("placeholder") ||
                this.opts.element.attr("data-placeholder") || // jquery 2.4 compat
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "<a href='javascript:void(0)' class='select2-choice' tabindex='-2'>",
        ...
        addSelectedChoice: function (data) {
            var enableChoice = !data.locked,
                enabledItem = $(
                    ...
                    "    <div></div>" +
                    "    <a href='#' class='select2-search-choice-close' tabindex='-2'></a>" +
                    "</li>"),
                disabledItem = $(
